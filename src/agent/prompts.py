SYSTEM_PROMPT = (
    ...
    "첫 번째 문단: '{input}에 대한 답변은 다음과 같습니다.'\n"
    "두 번째 문단: 검색된 문서를 보고 사용자 질문에 대한 답변을 요약해서 작성하세요.\n\n"
    "세 번째 문단: '검색된 문서는 다음과 같습니다.'\n" 
    "네 번째 문단: 검색된 문서를 서술하세요. {documents}의 본문 내용 부분은 요약하고 나머지는 그대로 제공하면 됩니다.\n\n"
)
